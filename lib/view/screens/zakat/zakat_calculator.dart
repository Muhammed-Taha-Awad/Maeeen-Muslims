...
import 'package:maeeen/view/base/custom_button.dart';
import 'package:maeeen/view/screens/zakat/item_field.dart';
import 'package:maeeen/view/screens/zakat/result_field.dart';
...
class _ZakatCalculatorState extends State<ZakatCalculator> {
  ...
  Widget build(BuildContext context) {
    Get.find<QuranSettingsController>().fetchMosqueSettingsData();
    return Scaffold(
      // Appbar start ===>
      appBar: CustomAppBar(

...
class LocalDhikrCountScreen extends StatefulWidget {
  ...
  const LocalDhikrCountScreen({Key? key, required this.appBackButton})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DhikrController>(
      builder: (localDhikrController) {
        localDhikrController.localLoadCount(localDhikrController.localDhikrId.toString());
        return Scaffold(
          // Appbar start ===>
          appBar: CustomAppBar(
                                      ...
                                      actions: [
                                        TextButton(
                                          onPressed: () {
                                            ...
                                            localDhikrController.localDeleteCount(
                                                localDhikrController.localDhikrId
                                                    .toString());
                                          },
                                          child: Text(

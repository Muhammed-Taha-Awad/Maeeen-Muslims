            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  //   builder: (donationController) {
                  //   return CustomButton(
                  //     buttonLoderWidget: donationController.isAddedLoading.value? const Center(
                  //       child: SizedBox(
                  //         height: 20,
                  //         width: 20,
                  //         child: CircularProgressIndicator(
                  ...
                  //     buttonWidth: Get.width,
                  //     buttonName:  "go_for_payment".tr,
                  //     disableColor: amountController.text.isEmpty && emailController.text.isEmpty ?Theme.of(context).disabledColor:Theme.of(context).primaryColor,
                  //     onPressed: amountController.text.isEmpty && emailController.text.isEmpty?() {}:
                  //         () async {
                  //       if (_formKey.currentState!.validate()) {
                  //         Get.back();
                  //         donationController.razorpayValue(emailController.text, amountController.text);
                  //          donationController.paymentGateWayFun(context, amountController.text, emailController.text);
                  //
                  //
                  //
                  //       }

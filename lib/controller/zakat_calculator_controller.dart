...
//------------- All result TextEditingController Section   ------------//
  ...
  final isApiNisabExist = TextEditingController(
      text: Get.find<QuranSettingsController>()
          ...
          : Get.find<QuranSettingsController>()
                  ...
                  null
              ? null
              : "${Get.find<QuranSettingsController>().mosqueSettingsApiData!.data!.currencySymbol} ${Get.find<QuranSettingsController>().mosqueSettingsApiData!.data!.zakatNisab}");
...
//------------- Variable for Own section ------------//
  ...
  getZakat() {
    if (equalResult > double.parse(totalNisab.text)) {
      ...
      totalZakat.text =
          "${Get.find<QuranSettingsController>().mosqueSettingsApiData!.data!.automaticPayerTime == true ? "" : Get.find<QuranSettingsController>().mosqueSettingsApiData!.data!.currencySymbol} $total_zakat";
